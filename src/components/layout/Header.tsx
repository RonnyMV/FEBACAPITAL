  ...
  return (
    <>
      <header className="w-full bg-white shadow-sm h-[84px]">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between pl-[135px] pr-[135px]">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-black hover:text-green-600 font-medium">
              HOME
            </a>
            <a href="#" className="text-black hover:text-green-600 font-medium">
              SOBRE A LIVA
      ...
      >
        ...
        <div
          className={`relative w-[360px] h-full bg-white ml-auto transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
        >
          ...
          <div className="flex flex-col h-[calc(100vh-84px)]">
            <div className="flex-1 px-4 py-6 overflow-y-auto">
              <nav className="space-y-6">
                <a
                  href="#"
                  className="block text-black font-medium text-lg uppercase hover:text-green-600 transition-colors duration-200"
                >
                  HOME
                </a>
                <a
              ...
              <div className="mt-8">
                <h3 className="text-black font-medium text-sm mb-4">
                  Acompanhe nas redes
                </h3>
