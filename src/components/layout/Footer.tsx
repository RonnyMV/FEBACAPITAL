    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="text-2xl font-bold mb-4">LIVA</div>
          ...
          <div>
            <h3 className="text-green-600 font-semibold mb-4">NAVEGUE NO SITE</h3>
          ...
          <div>
            <h3 className="text-green-600 font-semibold mb-4">CONTATO</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white">contato@liva.com.br</span>
              </div>
              ...
              <button className="w-full bg-green-500 text-white px-6 py-3 rounded-md font-bold hover:bg-green-600 transition mt-6">
                WHATSAPP
              </button>
            </div>
          </div>
