...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-semibold rounded-md transition focus:outline-none focus:ring-2 focus:ring-green-300 disabled:opacity-50 disabled:cursor-not-allowed';
